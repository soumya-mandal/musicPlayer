...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    SeekBar seekBar;
    ImageView pausePlay, nexBtn, prevBtn, musicIcon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTV = findViewById(R.id.sonf_title);
        currentTimeTV = findViewById(R.id.current_time);
        totalTimeTV = findViewById(R.id.total_time);
        seekBar = findViewById(R.id.progress_bar);
        pausePlay = findViewById(R.id.pause_play);
        nexBtn = findViewById(R.id.next);
        ...
        MusicPlayerActivity.this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(mediaPlayer != null){
                    ...
                    if(mediaPlayer.isPlaying()) pausePlay.setImageResource(R.drawable.ic_baseline_pause_circle_filled_24);
                    else pausePlay.setImageResource(R.drawable.ic_baseline_play_circle_filled_24);
                }
    ...
    void setResourcesWithMusic(){
        ...
        nexBtn.setOnClickListener(v-> playNextSong());
